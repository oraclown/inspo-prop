...
export default function Home() {
  return (
    ...
    <div className="flex flex-col h-screen text-zinc-50">
      ...
      <h1 className="p-5 text-lg text-center font-serif font-family:'Times New Roman'">
      ...
      <main className="flex-1 flex flex-col justify-center font-serif font-family:'Times New Roman'">
        ...
        <button className="text-center p-1 mt-5 ml-5 mr-2.5 hover:bg-gradient-to-r from-teal-300 to-amber-300">click for next pics</button>
        <button className="text-center p-1 mt-5 ml-2.5 mr-5 hover:bg-gradient-to-r from-blue-300 to-pink-500">upload image</button>
        </div>
      </main>
